...
public class AuthFilter implements Filter {
    ...
    private boolean sessionNotEmpty(HttpSession ses, String reqURI) {
        return reqURI.indexOf("/login.xhtml") >= 0 || (ses != null && ses.getAttribute("user_name") != null) || reqURI.indexOf("/public/") >= 0 || reqURI.contains("javax.faces.resource");
    }
